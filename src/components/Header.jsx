...
export default function Header() {
    ...
    return (
        ...
        >
            ...
            >
                <div className="glass border-t border-white/5 px-4 md:px-6 py-6 md:py-8 flex flex-col gap-4 rounded-b-2xl">
                    {navLinks.map((link) => (
                        <a
                            key={link.href}
                            href={link.href}
                    ...
                    <div className="border-t border-white/10 pt-4 mt-1">
                        <a
                            href="tel:+79896341375"
                            className="font-body text-sm font-semibold text-gold flex items-center gap-2 cursor-pointer"
                        >
